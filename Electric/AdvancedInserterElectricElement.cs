...
namespace Logistics {
    public class AdvancedInserterElectricElement : ElectricElement {
        public double? m_lastDispenseTime;
        public SubsystemBlockEntities m_subsystemBlockEntities;

        public AdvancedInserterElectricElement(SubsystemElectricity subsystemElectricity, Point3 point) : base(
        ...
        public override bool Simulate() {
            if (CalculateHighInputsCount() > 0
                ...
                bool placed = false;
                if (blockEntity != null) {
                    var component = blockEntity.Entity.FindComponent<ComponentAdvancedInserter>();
                    if (component != null) {
                        placed = component.Place();
                    }
                }
                if (placed) {

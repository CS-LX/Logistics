...
| 文档 | 状态 | 说明 |
| --- | --- | --- |
| [输送带实现计划.md](输送带实现计划.md) | **已落地** | P0–P7 / M0–M7 已过黑盒（2026-07-26） |
| [料斗实现计划.md](料斗实现计划.md) | **已落地（待黑盒）** | 落料斗 / 受料斗：H0–H4 代码已合入 |
| [原料与锌消耗.md](原料与锌消耗.md) | 定位说明 | 副业：补齐 IE2 锌消耗；配方挂点与非目标 |
| [方块索引与变体约定.md](方块索引与变体约定.md) | 约定 | Index / Data；当前方块表（551–554） |

## 归档

已落地计划与调研对照见 [`archive/`](archive/)。

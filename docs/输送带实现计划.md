...
> 状态：**施工中**（P0–P5 已过黑盒；下一步 P6 打磨，可选）  
...
| 进档压力测试在途物散落 Pickable | **延后 P6（可选）**：视距 32 反复进退可复现，坡/端口 > 平直；视距 512 基本无。非首发 blocker |
...
下一步 **P6 打磨**（可选）：Sign UI、贴图停滚、Extensions/Utils、低视距散落等。玩法主干 P0–P5 已齐。

*计划修订：2026-07-25 — P0–P5 黑盒通过；下一步 P6 可选打磨。*

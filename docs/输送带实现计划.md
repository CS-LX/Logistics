...
> 状态：**施工中**（P0/P1 已过黑盒；下一步 P2 抓取机 IInventory）  
...
| `Subsystems/SubsystemConveyerBeltBlockBehavior.cs` | 朝向/爬坡；Rebuild；吸抛射物 | ✅ P0+P1 |
...
从 **P2 IInventory 对接抓取机** 开工：每格 Segment 门面、中段抽/塞、与末端弹出不冲突。

*计划修订：2026-07-25 — 冻结 A/B；剔除 Factorio 并存与无实体兼容。P0/P1 黑盒通过（编组 + 连续运物；调试键 F2）。*

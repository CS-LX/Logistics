...
| `Dialogs/ConveyerBeltDirectionDialog.cs` | 调向面板：无面板底、遮罩压到近透明、状态实时刷新 | ✅ P7 |
...
**P7 代码侧已落地**（透视调向面板、中枢拆分下沉、View/Model 分离、静态收敛、文案与调试收口；性能项按「按需」未做）；剩 **M7 黑盒回归**：调向时可透视观察带面，且 P0–P6 玩法不回退。
